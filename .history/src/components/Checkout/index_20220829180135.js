  ...
  return (
    ...
    >
      <div className="w-full font-semibold uppercase basis-2/3">
        ...
        <Input className="border-black w-72" name="name" onChange={handleChangeInfo} />
        <div className="flex mt-2">
          <div>
            <p className="mb-1">Tỉnh/ Thành Phố</p>
            <Input className="border-black w-72" name="province" onChange={handleChangeInfo} />
          </div>

          <div className="mb-2 ml-8">
            <p className="mb-1">Quận / Huyện</p>
            <Input className="border-black w-72" name="district" onChange={handleChangeInfo} />
          </div>
        </div>
        ...
        <div className="flex">
          <div>
            ...
            <Input className="border-black w-72" name="ward" onChange={handleChangeInfo} />
          </div>
