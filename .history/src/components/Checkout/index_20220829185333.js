...
export default function Checkout() {
  ...
  const handlePayment = () => {
    ...
    axios
      .post(`${baseURL}/uinvoices/invoice_create`, {
        id: values.id,
        email: values.email,
        name: values.name,
  ...
  return (
    ...
    >
      <div className="w-full font-semibold uppercase basis-2/3">
        ...
        {isPayment ? (
          <>
            <p className="mb-5 text-lg uppercase">Phương thức thanh toán</p>
            <Radio.Group
              ...
              <div className="flex items-center justify-between w-full ml-2">
                <div className="">
                  ...
                  <p className="mb-1 select-none">
                    Giá tiền: {formatMoney(item.price)}đ
                  </p>
                  <div className="flex items-center">
                    <p className="select-none">Số lượng: {item.cartQuantity}</p>
