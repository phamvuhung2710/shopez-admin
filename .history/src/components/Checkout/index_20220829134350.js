  ...
  return (
    ...
    >
      ...
      <div className="p-8 basis-1/3 bg-slate-200">
        ...
        <div className="flex items-center justify-between pt-2 mb-4 font-semibold border-t border-black">
          <p className="uppercase">Tổng: </p>
          <p>200.000</p>
        </div>

        <div className="flex flex-col mt-16">
          <button className="uppercase bg-orange-400 text-[16px] mb-8 py-3">
            tiếp tục
          </button>
          <button className="underline uppercase text-[16px]">quay lại</button>
        </div>
      </div>
    </div>
  )
