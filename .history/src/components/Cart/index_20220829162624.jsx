...
function Cart() {
  ...
  // const numberProductInCart = cart.reduce((a, b) => {
  //   return a + b.cart.cartQuantity
  // }, 0)

  console.log('cart: ', cart)
  // console.log('numberProductInCart: ', numberProductInCart)
    ...
    <>
      <div className="relative cartIcon" onClick={showInsideCart}>
        {cart.cartItems.length !== 0 && (
          <div class="inline-flex absolute top-4 -right-4 justify-center items-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white dark:border-gray-900">
