    ...
    <>
      <div className="relative cartIcon" onClick={showInsideCart}>
        {numberProductInCart !== 0 && (
          <div class="inline-flex absolute top-4 -right-4 justify-center items-center w-7 h-7 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white dark:border-gray-900">
