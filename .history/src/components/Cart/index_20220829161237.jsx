  ...
  return (
    <>
      <div className="cartIcon" onClick={showInsideCart}>
        <div class="relative  inline-flex absolute -top-2 -right-2 justify-center items-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white dark:border-gray-900">
          {cartTotalQuantity}
        </div>
