    ...
    <>
      <div className="relative cartIcon" onClick={showInsideCart}>
        {cart.cartItems.length !== 0 && (
          <div class="inline-flex absolute -top-2 -right-2 justify-center items-center w-6 h-6 text-xs font-bold text-white bg-red-500 rounded-full border-1 border-white dark:border-gray-900">
