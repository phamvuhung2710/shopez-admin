  ...
  return (
    ...
    >
      <div className="w-full font-semibold uppercase basis-2/3">
        ...
        >
          <Radio className="px-3 py-2 mb-2 border border-black" value={1}>
            thanh toán khi nhận hàng
          </Radio>
          <Radio className="px-3 py-2 mb-2 border border-black" value={2}>
            Momo
          </Radio>
          <Radio className="px-3 py-2 mb-2 border border-black" value={3}>
            zalopay
          </Radio>
          <Radio className="px-3 py-2 mb-2 border border-black" value={4}>
            paypal
          </Radio>
          <Radio className="px-3 py-2 mb-2 border border-black" value={5}>
            thẻ
          </Radio>
        </Radio.Group>
      </div>
